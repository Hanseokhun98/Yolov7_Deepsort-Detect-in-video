...
area1_pointA = (240,0)
area1_pointB = (240,700)
area1_pointC = (360,0)
area1_pointD = (360,700)

area2_pointA = (361, 0)
area2_pointB = (361, 700)
area2_pointC = (480, 0)  # Keep the y-coordinate the same as area2_pointA
area2_pointD = (480, 700)  # Keep the y-coordinate the same as area2_pointB

area3_pointA = (481, 0)
area3_pointB = (481, 700)
area3_pointC = (600, 0)  # Keep the y-coordinate the same as area2_pointA
area3_pointD = (600, 700)  # Keep the y-coordinate the same as area2_pointB

area4_pointA = (601, 0)
area4_pointB = (601, 700)
area4_pointC = (720, 0)  # Keep the y-coordinate the same as area2_pointA
area4_pointD = (720, 700)  # Keep the y-coordinate the same as area2_pointB

area5_pointA = (721, 0)
area5_pointB = (721, 700)
area5_pointC = (840, 0)  # Keep the y-coordinate the same as area2_pointA
area5_pointD = (840, 700)  # Keep the y-coordinate the same as area2_pointB
...
def draw_boxes(img, bbox, identities=None, categories=None, names=None, offset=(0, 0)):
    global counting_area1  # To modify the global counting_roi1 variable
    global counting_area2  # To modify the global counting_roi2 variable
    global counting_area3  # To modify the global counting_roi3 variable
    global counting_area4  # To modify the global counting_roi4 variable
    global counting_area5  # To modify the global counting_roi5 variable
    global array_ids  # To modify the global array_ids variable
    global area1_object_ids
    global area2_object_ids
    global area3_object_ids
    global area4_object_ids
    global area5_object_ids
...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            # Draw lines for area2
            cv2.line(im0, area2_pointA, area2_pointB, (0, 0, 255), 2)
            cv2.line(im0, area2_pointB, area2_pointD, (0, 0, 255), 2)
            cv2.line(im0, area2_pointC, area2_pointD, (0, 0, 255), 2)
            cv2.line(im0, area2_pointA, area2_pointC, (0, 0, 255), 2)

            cv2.line(im0, area3_pointA, area3_pointB, (255, 0, 0), 2)
            cv2.line(im0, area3_pointB, area3_pointD, (255, 0, 0), 2)
            cv2.line(im0, area3_pointC, area3_pointD, (255, 0, 0), 2)
            cv2.line(im0, area3_pointA, area3_pointC, (255, 0, 0), 2)

            cv2.line(im0, area4_pointA, area4_pointB, (0, 255, 255), 2)
            cv2.line(im0, area4_pointB, area4_pointD, (0, 255, 255), 2)
            cv2.line(im0, area4_pointC, area4_pointD, (0, 255, 255), 2)
            cv2.line(im0, area4_pointA, area4_pointC, (0, 255, 255), 2)

            cv2.line(im0, area5_pointA, area5_pointB, (255, 0, 255), 2)
            cv2.line(im0, area5_pointB, area5_pointD, (255, 0, 255), 2)
            cv2.line(im0, area5_pointC, area5_pointD, (255, 0, 255), 2)
            cv2.line(im0, area5_pointA, area5_pointC, (255, 0, 255), 2)
            ...
            cv2.putText(im0, 'Area1 Count = ' + str(counting_area1), org_area1, font, fontScale, color, thickness, cv2.LINE_AA)
            cv2.putText(im0, 'Area2 Count = ' + str(counting_area2), org_area2, font, fontScale, color, thickness, cv2.LINE_AA)
            cv2.putText(im0, 'Area3 Count = ' + str(counting_area3), org_area3, font, fontScale, color, thickness, cv2.LINE_AA)
            cv2.putText(im0, 'Area4 Count = ' + str(counting_area4), org_area4, font, fontScale, color, thickness, cv2.LINE_AA)
            cv2.putText(im0, 'Area5 Count = ' + str(counting_area5), org_area5, font, fontScale, color, thickness, cv2.LINE_AA)
...
#python original.py --weights nice.pt --no-trace --view-img --nosave --source test4.avi --device 0 --classes 1