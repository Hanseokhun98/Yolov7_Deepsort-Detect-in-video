    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            for c in det[:, -1].unique():
                ...
                print(f'BAR2 count: {count_bar2}')
                print(f'RACK count: {count_rack}')
            ...
            cv2.line(im0,area1_pointC,area1_pointD,(0,444,0),2)
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        save_folder = 'object detection model/yolov7'
        np.savetxt(save_folder + 'detected_coordinates.csv', coordinates_list, delimiter=',', fmt='%f')